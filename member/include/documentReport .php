    ...
    <div class="modal modal-centered">
        <div class="modal-content shadow-lg p-5">
            ...
            <select
                ...
                <option value="regn. no.">Purpose</option>
                <option value="volume">Charges</option>
                <option value="book">recieved</option>
                <option value="regn. date">Balanced</option>
            </select>
            <button
