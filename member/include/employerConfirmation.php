<div id='centeredFormModalAllEmployerDelete' class="modal-wrapper">
            ...
            <div
                ...
                <div class="md:flex items-center">
                    ...
                    <div class="mt-2  md:ml-6 text-center md:text-left">
                        ...
                        <p class="text-sm text-gray-700 mt-1">You will lose all of your employers records and this action
                            cannot be undone.
                        </p>
                    </div>
                </div>
                <div class="text-center md:text-right mt-4 md:flex md:justify-end">
                    <button
                        ...
                        onclick="deleteAllEmployerData()">Confirm</button>
                    <button class="close-modal close-model-employer cursor-pointer  block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-gray-200 rounded-lg font-semibold text-sm mt-4
